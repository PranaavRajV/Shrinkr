    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div>
            ...
            <input
              ...
              onFocus={(e) => ((e.target as HTMLInputElement).style.borderColor = '#DFE104')}
        ...
        <div style={{ marginTop: '24px', textAlign: 'center', fontSize: '12px', color: '#555' }}>
          ALREADY HAVE ONE? <Link to="/login" style={{ color: '#DFE104', textDecoration: 'none', fontWeight: 700 }}>LOG IN</Link>
        </div>
      </div>
    </div>
  )
